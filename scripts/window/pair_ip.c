...
void ConnectCallback(const char *name) {
...
void BeforeLeftC(SDL_Event *event) {
    InitLogFile("logs.txt");
...
void Pair_ip(SDL_Window* Window, SDL_Renderer* Renderer) {
    InitLogFile("logs.txt");
    ...
    CreateClickableElement(Renderer, 220, 220, &width, &height, "Connect", textColor, "medias/images/square-btn.png", ConnectCallback, 12);
    CreateClickableElement(Renderer, 12, 11, &width3, &height3, NULL, textColor, "medias/images/left-arrow.png", BeforeLeftC, 12);
